...
const MainAppContent: React.FC = () => {
  const { currentUser, loading, logout, isDemoUser } = useAuth();
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col justify-between p-6 sm:p-12">
        ...
        <div className="max-w-7xl w-full mx-auto flex items-center justify-between border-b border-slate-200 pb-5">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="font-extrabold text-base sm:text-lg tracking-tight text-slate-900 font-futuristic">
                Clinical Workspace
              </h1>
        ...
        <div className="max-w-4xl w-full mx-auto my-auto py-12 space-y-10">
          <div className="text-center space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-xs font-bold text-indigo-700">
              ...
              <span>Welcome Back Gaissss</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            ...
            <div 
              ...
              className="group bg-white rounded-2xl border border-slate-200 p-6 flex flex-col justify-between space-y-6 hover:shadow-xl hover:border-slate-300 hover:-translate-y-0.5 transition-all cursor-pointer shadow-2xs"
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-extrabold text-slate-900 text-base sm:text-lg group-hover:text-indigo-600 transition-colors">
                    Outsource Database
                  </h3>
            ...
            {/* Card 2: Stock Take (Venepuncture Hub) */}
            <div 
              onClick={() => {
            ...
            >
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-xl bg-violet-50 border border-violet-100 text-violet-600 flex items-center justify-center transition-colors group-hover:bg-violet-600 group-hover:text-white shrink-0 shadow-xs">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-extrabold text-slate-900 text-base sm:text-lg group-hover:text-rose-600 transition-colors">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-extrabold text-slate-900 text-base sm:text-lg group-hover:text-blue-600 transition-colors">
                    Holter Schedule
                  </h3>
                  <p className="text-xs text-slate-500 leading-relaxed">
            ...
            >
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-xl bg-teal-50 border border-teal-100 text-teal-600 flex items-center justify-center transition-colors group-hover:bg-teal-600 group-hover:text-white shrink-0 shadow-xs animate-pulse">
                  <HeartPulse className="w-6 h-6" />
                </div>
                <div className="space-y-1.5">
                  <h3 className="font-extrabold text-slate-900 text-base sm:text-lg group-hover:text-teal-600 transition-colors">
